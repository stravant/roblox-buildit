...
|---|---|---|
| Minifig articulation | ~124 | PARTLY DONE: torso neck Stud, head Pocket/top stud, hand C-grip (cylo bore), hips+legs two-joint composite, hats via tubes, stud-in-pinhole "mouth" mate rule. Friends minidolls: head neck-bore/hair-stud and torso neck-pin/hip-receivers all auto-detect via the r4 bar rules; hips 1015152's D-posts curated. Remaining: minifig arms (wrist sockets, print-variant-heavy), integral-arm figures (15/17), Friends legs variants (per-part hip posts, curate on demand), minidoll hand grips (deep subparts, unverified). |
