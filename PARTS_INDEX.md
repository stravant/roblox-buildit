...
| Minifig core | 973 (torso: neck Stud override), 3626b/a (head: bottom neck Pocket override + real stud2a top stud), 3820 (hand: inverted r4 cylo C-grip = BarHole), 3815+3816+3817 via 3815c01 (hips+legs: TWO-joint composite, legs swing independently on the shared hip axis), 3624-style hats (stud4 tube grips the head stud) | overrides + cylo bore keying + multi-joint composite | Stud/Pocket/BarHole/Composite |
