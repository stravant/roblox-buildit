#!/usr/bin/env python3
"""
Test runner for the BuildIt project.

Builds the test runner plugin, starts a WebSocket server,
waits for Roblox Studio to connect, then streams test results to stdout.

Also serves files out of the ldraw/ directory to the tests on request
("readfile" messages), so specs can exercise the real LDraw part library.
